...
else
{
   ...
   echo '</tr>';
	...
	else
	{
		...
		echo '</td>';
		echo '<td class="category" colspan="1">';
		echo plugin_lang_get( 'config_TAMHighlighting' );
		echo '</td>';
		echo '</td>';
		echo '<td width="100px" colspan="1">';
		?>
		<label><input type="radio" name="TAMHighlighting" value="1" <?php echo ( ON == plugin_config_get( 'TAMHighlighting' ) ) ? 'checked="checked" ' : ''?>/><?php echo plugin_lang_get( 'config_y' ) ?></label>
		<label><input type="radio" name="TAMHighlighting" value="0" <?php echo ( OFF == plugin_config_get( 'TAMHighlighting' ) ) ? 'checked="checked" ' : ''?>/><?php echo plugin_lang_get( 'config_n' ) ?></label>
		<?php
		echo '</td>';
		
		echo '<td class="category" colspan="1">';
		echo plugin_lang_get( 'config_TAGHighlighting' );
		echo '</td>';
		echo '</td>';
		echo '<td width="100px" colspan="1">';
		?>
		<label><input type="radio" name="TAGHighlighting" value="1" <?php echo ( ON == plugin_config_get( 'TAGHighlighting' ) ) ? 'checked="checked" ' : ''?>/><?php echo plugin_lang_get( 'config_y' ) ?></label>
		<label><input type="radio" name="TAGHighlighting" value="0" <?php echo ( OFF == plugin_config_get( 'TAGHighlighting' ) ) ? 'checked="checked" ' : ''?>/><?php echo plugin_lang_get( 'config_n' ) ?></label>
		<?php
		echo '</td>';
	echo '</tr>';
